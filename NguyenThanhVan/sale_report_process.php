      ...
      <table class="table table-border">
        ...
        <tbody>
          <?php foreach ($results as $result): ?>
            <tr>
              ...
              <td class=""><?php echo remove_junk($result['order_date']); ?></td>
              <td class="desc">
        ...
        <tfoot>
          <tr class="text-right">
            ...
            <td><?php echo number_format(total_price($results)[0], 2); ?> vnđ</td>
          </tr>
          <tr class="text-right">
            <td colspan="4"></td>
            <td colspan="1">Lợi nhuận</td>
            <td><?php echo number_format(total_price($results)[1], 2); ?> vnđ</td>
          </tr>
        </tfoot>
      </table>
    </div>
